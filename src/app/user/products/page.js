        ...
        <div className="w-full min-h-screen bg-black py-25 ">
            ...
            <div className="w-full mt-5 flex justify-evenly items-start flex-wrap ">
                ...
                {prd && prd.map((ele, idx) => (
                    ...
                    <div key={idx} className='w-[350px] mt-10 h-max bg-white pt-3 pb-5 px-3 gx_sh group rounded-xl relative '>
